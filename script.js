...
var advancementlist = ["Gather 3 Wood", "Get An Iron Pickaxe", "Kill 10 Cows/Pigs"
                    ...
                    , "Gather 10 Iron Ingots", "Gather 64 Smelted Stone", "Find a revine and remove all visable ores", "Mine Obsidian"
...
function end() {
    ...
    document.getElementById("stop").innerHTML = "<br><h1>Refresh</h1><br>";
    return;
}
